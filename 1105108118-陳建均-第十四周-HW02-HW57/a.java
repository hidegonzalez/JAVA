...
import java.util.*;
 public class a{
     public static void main (String[] args)throws IOException{
		 ...
		 staff =Integer.parseInt(buf.readLine());    
         ...
         switch(staff){
         case 0 :  {
              e[cont] =new Basic_Employee(n,s,p,a,y);
             e[cont].show();
             cost=e[cont].salary()+cost;
             cont++;
             break;}
         case 1 : {
              e[cont]=new managers(n,s,p,a,y);
             e[cont].show();
             cost=e[cont].salary()+cost;
             cont++;
             break;}
        case 2 : {
             e[cont]=new supervisors(n,s,p,a,y);
            e[cont].show();
            cost=e[cont].salary()+cost;
            cont++;
            break;}
